...
static inline fmi2Integer Arduino_SerialCommunication_Functions_math__floor(fmi2Component comp, fmi2Real om_x);
...
static fmi2Status servo_pot_functionOutputs(fmi2Component comp)
{
  ...
  comp->fmi2IntegerVars[0] /* pwm._u[1] DISCRETE */ = Arduino_SerialCommunication_Functions_math__floor(comp, comp->fmi2RealVars[0] /* adc._y variable */); /* equation 5 */Modelica__DeviceDrivers_EmbeddedTargets_AVR_Functions_RealTimeSynchronization_wait(comp, comp->extObjs[4] /* synchronizeRealtime1._sync EXTOBJ: Modelica_DeviceDrivers.EmbeddedTargets.AVR.Functions.RealTimeSynchronization.Init */);Modelica__DeviceDrivers_EmbeddedTargets_AVR_Functions_PWM_set(comp, comp->extObjs[2] /* pwm._pwm[1] EXTOBJ: Modelica_DeviceDrivers.EmbeddedTargets.AVR.Functions.PWM.Init */, comp->fmi2IntegerVars[0] /* pwm._u[1] DISCRETE */);
}
